        ...
        <div className="space-y-1">
          ...
          <div className="grid gap-1.5">
            {[
              ...
              { name: 'TRT World',           url: 'https://api.trtworld.com/livestream/v1/WcM3Oa2LHD9iUjWDSRUI335NkMWVTUV351H56dqC/master.m3u8',         country: '🌍', cat: 'News' },
              { name: 'Sky News',            url: 'https://linear021-gb-hls1-prd-ak.cdn.skycdp.com/Content/HLS_001_hd/Live/channel(skynews)/index_mob.m3u8', country: '🇬🇧', cat: 'News' },
              { name: 'NASA TV',             url: 'https://ntv1.akamaized.net/hls/live/2014075/NASA-NTV1-HLS/master.m3u8',                                country: '🚀', cat: 'Docs' },
              { name: 'ABC News (AU)',        url: 'https://abc-iview-mediapackagestreams-2.akamaized.net/out/v1/6e1cc6d25ec0480ea099a5399d73bc4b/index.m3u8', country: '🇦🇺', cat: 'News' },
              // ── Sports ──
              ...
              { name: 'Dubai Sports 3',      url: 'https://dmitwlvvll.cdn.mangomolo.com/dubaisportshd5/smil:dubaisportshd5.smil/index.m3u8',              country: '⚽', cat: 'Sport' },
              { name: 'Alkass One',          url: 'https://www.tvkaista.net/stream-forwarder/get.php?x=AlkassOne',                                        country: '⚽', cat: 'Sport' },
              { name: 'Alkass Two',          url: 'https://www.tvkaista.net/stream-forwarder/get.php?x=AlkassTwo',                                        country: '⚽', cat: 'Sport' },
              // ── Movies / Entertainment ──
              { name: 'FilmRise Movies',     url: 'http://dai2.xumo.com/xumocdn/p=roku/amagi_hls_data_xumo1212A-filmrisefreemovies/CDN/playlist.m3u8',    country: '🎬', cat: 'Movies' },
              { name: 'Classic Movies',      url: 'http://service-stitcher.clusters.pluto.tv/stitch/hls/channel/561c5b0dada51f8004c4d855/master.m3u8',    country: '🎬', cat: 'Movies' },
              { name: 'Pluto TV Action',     url: 'http://service-stitcher.clusters.pluto.tv/stitch/hls/channel/561d7d484dc7c8770484914a/master.m3u8',    country: '🎬', cat: 'Movies' },
              { name: 'Pluto TV Comedy',     url: 'http://service-stitcher.clusters.pluto.tv/stitch/hls/channel/5a4d3a00ad95e4718ae8d8db/master.m3u8',    country: '😂', cat: 'Movies' },
              { name: 'Pluto TV Horror',     url: 'http://service-stitcher.clusters.pluto.tv/stitch/hls/channel/569546031a619b8f07ce6e25/master.m3u8',    country: '👻', cat: 'Movies' },
              { name: 'Pluto TV Thrillers',  url: 'http://service-stitcher.clusters.pluto.tv/stitch/hls/channel/5b4e69e08291147bd04a9fd7/master.m3u8',    country: '🎭', cat: 'Movies' },
              { name: 'Pluto TV Westerns',   url: 'http://service-stitcher.clusters.pluto.tv/stitch/hls/channel/5b4e94282d4ec87bdcbb87cd/master.m3u8',    country: '🤠', cat: 'Movies' },
              { name: 'Pluto TV Docs',       url: 'http://service-stitcher.clusters.pluto.tv/stitch/hls/channel/5b85a7582921777994caea63/master.m3u8',    country: '📽️', cat: 'Docs' },
              { name: 'Black Cinema',        url: 'http://service-stitcher.clusters.pluto.tv/stitch/hls/channel/58af4c093a41ca9d4ecabe96/master.m3u8',    country: '🎥', cat: 'Movies' },
              // ── African / Nollywood ──
              { name: 'Africanews',          url: 'https://ythls.armelin.one/channel/UCQfwfsi5VrQ8yKZ-UWmAEFg.m3u8',                                      country: '🌍', cat: 'Africa' },
              { name: 'TVC News Nigeria',    url: 'https://ythls.armelin.one/channel/UCZFMm1mMw0F81Z37aaEzTUA.m3u8',                                      country: '🇳🇬', cat: 'Africa' },
              { name: 'Channels TV Nigeria', url: 'https://ythls.armelin.one/channel/UChd1DEecCRlxaa0-hvPACCw.m3u8',                                      country: '🇳🇬', cat: 'Africa' },
              { name: 'SABC News',           url: 'https://sabconetanw.cdn.mangomolo.com/news/smil:news.stream.smil/chunklist_b250000_t64MjQwcA==.m3u8',  country: '🇿🇦', cat: 'Africa' },
              { name: 'MBC 1 (Arabic)',      url: 'https://mbc1-enc.edgenextcdn.net/out/v1/0965e4d7deae49179172426cbfb3bc5e/index.m3u8',                  country: '🌍', cat: 'Africa' },
