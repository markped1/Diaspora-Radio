...
// Kept to 8 feeds max to avoid 429 rate limiting
const RSS_FEEDS = [
  // ── Nigerian sources (most reliable with rss2json) ────────────────────────
  ...
  // ── African / global (confirmed working) ─────────────────────────────────
